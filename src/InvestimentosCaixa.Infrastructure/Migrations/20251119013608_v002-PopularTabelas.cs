        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@" 
                ...
                INSERT INTO Produto (TipoProdutoId, Nome, RentabilidadeAnual, PrazoMinimoMeses) VALUES
                    (1, 'Poupança Caixa', 0.0692, 0),
                    (1, 'Poupança Caixa 2', 0.0601, 0),
                    (2, 'CDB Caixa 100% CDI', 0.1453, 6),
                    (2, 'CDB Caixa 110% CDI', 0.1554, 12),
                    (2, 'CDB Liquidez Diária Caixa', 0.1413, 0),
                    (3, 'Ações Petrobras (PETR4)', 0.2021, 0),
                    (3, 'Ações Vale (VALE3)', 0.2585, 0),
                    (3, 'Ações Magazine Luiza (MGLU3)', 0.2010, 0),
                    (4, 'LCI Caixa Imobiliária 2027', 0.1416, 12),
                    (5, 'LCA Caixa Agronegócio 2026', 0.1492, 6),
                    (6, 'Tesouro IPCA+ 2029', 0.0650, 0),
                    (7, 'Fundo Multimercado Caixa Premium', 0.1213, 0);
                ...
                INSERT INTO PerfilPontuacaoRisco (RiscoId, PontosBase, Multiplicador, PontosMaximos) VALUES 
                    ...
                    (2, 20, 1.3, 30),   -- Médio risco → até 30
                    (3, 25, 1.6, 45);   -- Alto risco → até 45
                ...
                INSERT INTO Simulacao (ClienteId, ProdutoId, ValorInvestido, ValorFinal, PrazoMeses, RentabilidadeEfetiva, DataSimulacao) VALUES
                    (1, 1, 1500.00, 1590.00, 12, 0.06, '2025-01-11'),
                    (1, 3,  890.00,  910.76, 6,  0.14, '2025-03-09'),
                    (2, 3, 3000.00, 3420.00, 12, 0.14, '2025-03-09'),
                    (2, 6, 2000.00, 2400.00, 12, 0.20, '2025-03-21'),
                    (3, 8, 1200.00, 1368.00, 12, 0.20, '2025-03-31'),
                    (3, 9, 2500.00, 2850.00, 12, 0.14, '2025-04-14'),
                    (4, 2,  900.00,  954.60, 12, 0.06, '2025-01-24'),
                    (4, 7, 4000.00, 5000.00, 12, 0.25, '2025-02-17'),
                    (5, 7, 3200.00, 4000.00, 12, 0.25, '2025-02-17'),
                    (5,10, 2000.00, 2093.33, 3,  0.14, '2025-04-04'),
                    (5, 7, 1500.00, 1570.00, 3,  0.14, '2025-04-04');

                INSERT INTO Investimento (ClienteId, ProdutoId, Valor, Rentabilidade, Data) VALUES
                    (1, 6, 1500.00, 0.20, '2025-04-05'),
                    (1, 7, 3000.00, 0.25, '2025-04-04'),
                    (1, 8, 1500.00, 0.20, '2025-04-04'),
                    (2, 12, 1500.00, 0.12, '2025-04-03'),
                    (2, 2, 1500.00, 0.06, '2025-03-10'),
                    (3, 3, 1500.00, 0.14, '2025-03-10'),
                    (3, 4, 1500.00, 0.155, '2025-10-15'),
                    (3, 1, 1500.00, 0.06, '2025-02-20'),
                    (4, 3, 1500.00, 0.14, '2025-01-10'),
                    (4, 3, 1500.00, 0.14, '2025-07-16'),
                    (4, 3, 1500.00, 0.14, '2025-09-09'),
                    (4, 3, 1500.00, 0.14, '2025-03-08'),
                    (4, 1, 1500.00, 0.20, '2025-02-10');
