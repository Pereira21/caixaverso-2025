        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@" 
                ...
                INSERT INTO Simulacao (ClienteId, ProdutoId, ValorInvestido, ValorFinal, PrazoMeses, RentabilidadeEfetiva, DataSimulacao) VALUES
                    ...
                    (1, 3,  890.00,  994.02, 6,  0.1180, '2025-03-09'),
                    (2, 3, 3000.00, 3366.00, 12, 0.1220, '2025-03-09'),
                    ...
                    (4, 7, 4000.00, 4460.00, 12, 0.1150, '2025-02-17'),
                    (5, 7, 3200.00, 3760.00, 12, 0.1750, '2025-02-17'),
                    (5,10, 2000.00, 2238.00, 3,  0.1190, '2025-04-04');

                INSERT INTO Investimento (ClienteId, ProdutoId, Valor, Rentabilidade, Data) VALUES
                    (1, 6, 1500.00, 0.1190, '2025-04-05'),
                    (1, 7, 3000.00, 0.1180, '2025-04-04'),
                    (1, 8, 1500.00, 0.1090, '2025-04-04'),
                    (2, 12, 1500.00, 0.0650, '2025-04-03'),
                    (2, 2, 1500.00, 0.1221, '2025-03-10'),
                    (3, 3, 1500.00, 0.0650, '2025-03-10'),
                    (3, 4, 1500.00, 0.1750, '2025-10-15'),
                    (3, 1, 1500.00, 0.1190, '2025-02-20'),
                    (4, 3, 1500.00, 0.0640, '2025-01-10'),
                    (4, 3, 1500.00, 0.0650, '2025-07-16'),
                    (4, 3, 1500.00, 0.1750, '2025-09-09'),
                    (4, 3, 1500.00, 0.1300, '2025-03-08'),
                    (4, 1, 1500.00, 0.0650, '2025-02-10');
